...
while not end:
  ...
  if ((not rangeMin.lstrip("-").isnumeric()) and ((not rangeMax.lstrip("-").isnumeric())) or (not rangeMin.lstrip("-").isnumeric()) or (not rangeMax.lstrip("-").isnumeric()) or not rangeMax or not rangeMin):
